...
export class VideoComponent {
  ...
  iconosDerecha = [
    {
      title: 'empresas.TitEnergizante',
      subtitle: 'empresas.SubEnergizante',
    ...
    {
      title: 'empresas.TitPortable',
      subtitle: 'empresas.SubPortable',
    ...
    {
      title: 'empresas.TitVersatil',
      subtitle: 'empresas.SubVersatil',
    ...
    {
      title: 'empresas.TitNutritivo',
      subtitle: 'empresas.SubNutritivo',
