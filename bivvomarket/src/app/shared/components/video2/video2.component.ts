...
export class Video2Component {
  ...
  iconosDerecha = [
    {
      title: 'Video2Component.TitRefrescante',
      subtitle: 'Video2Component.SubRefrescante',
    ...
    {
      title: 'Video2Component.TitEnergetico',
      subtitle: 'Video2Component.SubEnergetico',
    ...
    {
      title: 'Video2Component.TitVitaminado',
      subtitle: 'Video2Component.SubVitaminado',
      svg: '<svg  xmlns="http://www.w3.org/2000/svg"  stroke="#225e26"  width="54"  height="54" viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-blender"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 10h-3a1 1 0 0 1 -1 -1v-4a1 1 0 0 1 1 -1h10.802a1 1 0 0 1 .984 1.179l-1.786 9.821" /><path d="M8 4l2 11" /><path d="M11 15h4a3 3 0 0 1 3 3v2a1 1 0 0 1 -1 1h-8a1 1 0 0 1 -1 -1v-2a3 3 0 0 1 3 -3z" /><path d="M12 4v-1h2v1" /><path d="M13 18v.01" /></svg>',
    },
    {
      title: 'Video2Component.TitSaludable',
      subtitle: 'Video2Component.SubSaludable',
